...
import { DEFAULT_PANEL_PATH, DEFAULT_PANEL_LOCK, DEFAULT_PANEL_FULLBLEED, DEFAULT_PANEL_WORKSPACE,
         DEFAULT_GRAPHIC_PATH,
         DEFAULT_SOUND_PATH, DEFAULT_SOUND_VOLUME, DEFAULT_SOUND_PAN } from '@odatnurd/omphalos-common/constants';
...
A bundle always includes the contents of the
[[panelPath|guide.bundles#panelpath]],
[[graphicPath|guide.bundles#graphicpath]] and
[[soundPath|guide.bundles#soundpath]].
...
code; this must export the appropriate [[extension|guide.extensions]] symbols.

### panelPath

* optional
* default: <code>"{DEFAULT_PANEL_PATH}"</code>
...
* optional
* default: <code>{String(DEFAULT_PANEL_LOCK)}</code>
...
* optional
* default: <code>"{DEFAULT_PANEL_WORKSPACE}"</code>
...
* optional
* default: <code>{String(DEFAULT_PANEL_FULLBLEED)}</code>
...
* optional
* default: <code>"{DEFAULT_GRAPHIC_PATH}"</code>
...
* optional
* default: <code>"{DEFAULT_SOUND_PATH}"</code>
...
* optional
* default: <code>{DEFAULT_SOUND_VOLUME}</code>
...
* optional
* default: <code>{DEFAULT_SOUND_PAN}</code>
