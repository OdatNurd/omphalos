...
&mdash; and it orchestrates communications between the [[extension|extensions]]
code, the control[[panels]] the bundle provides, and the [[graphics]] that are
displayed directly in [OBS][3].
