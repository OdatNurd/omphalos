...
This event is raised by a call to [omphalos.form.save](/api/omphalos/form/save)
to save a form to storage. The event invokes prior to the save taking place, and
